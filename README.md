...
~~~bash
uvx --from katana-markdown-linter==0.19.5 kml check README.md
uvx --from katana-markdown-linter==0.19.5 kml-mcp --workspace-root /absolute/path/to/workspace
~~~
...
~~~bash
curl -LO https://github.com/HiroyukiFuruno/katana-markdown-linter/releases/download/v0.19.5/kml-v0.19.5-aarch64-apple-darwin.tar.gz
curl -LO https://github.com/HiroyukiFuruno/katana-markdown-linter/releases/download/v0.19.5/kml-v0.19.5-aarch64-apple-darwin.tar.gz.sha256
shasum -a 256 -c kml-v0.19.5-aarch64-apple-darwin.tar.gz.sha256
tar -xzf kml-v0.19.5-aarch64-apple-darwin.tar.gz
~~~
...
KML_MCP_REMOTE_TOKEN=change-me \
  uvx --from katana-markdown-linter==0.19.5 kml-mcp-remote
~~~
...
~~~bash
just VERSION=v0.19.5 mcpb-smoke
~~~
