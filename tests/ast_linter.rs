...
fn ast_linter_release_local_ci_parity_and_retry_safety() {
    ...
    let required = [
        ...
        (".github/workflows/release.yml", &workflow, "run: just schema-check"),
        ...
        (".github/workflows/release.yml", &workflow, "schema_asset=\"markdownlint.schema.${TAG}.json\""),
        (".github/workflows/release.yml", &workflow, "cp \"schema/markdownlint.schema.json\" \"$schema_asset\""),
        (".github/workflows/release.yml", &workflow, "\"$schema_asset\""),
        (".github/workflows/release.yml", &workflow, "gh release upload \"$TAG\" \"$PACKAGE_PATH\" \"$CHECKSUM_PATH\" \"$MCPB_PATH\" \"$MCPB_CHECKSUM_PATH\" \"$SERVER_JSON_PATH\" \"$schema_asset\" \"${binary_assets[@]}\" --clobber"),
