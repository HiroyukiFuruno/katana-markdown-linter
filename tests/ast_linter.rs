...
fn ast_linter_release_local_ci_parity_and_retry_safety() {
    ...
    let required = [
        ("Makefile", &makefile, "release-check: fmt-check lint ast-lint release-test dogfood coverage-blocking examples mcp-build mcp-stdio-smoke mcpb-smoke action-smoke"),
