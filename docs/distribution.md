...
`kml-v0.19.5-aarch64-apple-darwin.tar.gz`,
`kml-mcp-v0.19.5-aarch64-apple-darwin.tar.gz`, and
`kml-mcp-remote-v0.19.5-aarch64-apple-darwin.tar.gz`. Each archive ships a
