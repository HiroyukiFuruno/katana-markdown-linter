...
1. Apply `formatter-productization` for `v0.10.0`.
2. Apply `tool-distribution-and-editor-expansion` for `v0.11.0`.
3. Apply `mcp-workspace-tools-productization` when workspace MCP usage is prioritized.
