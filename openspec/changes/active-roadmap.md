...
| Done | MCP Registry and distribution planning for `v0.13.0` | `v0-13-0-mcp-registry-and-distribution-planning` | Defined package type, `server.json` draft, security review checklist, and public readiness gate. |
