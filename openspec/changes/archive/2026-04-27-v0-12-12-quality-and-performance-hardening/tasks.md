...
<<<<<<< HEAD:openspec/changes/v0-12-12-quality-and-performance-hardening/tasks.md
<<<<<<< HEAD
...
>>>>>>> origin/main:openspec/changes/archive/2026-04-27-v0-12-12-quality-and-performance-hardening/tasks.md
*目的: リファクタリング中の検証を阻害するノイズを最初に取り除き、検証環境を完全にクリーンにする*
>>>>>>> origin/main
