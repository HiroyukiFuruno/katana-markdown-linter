# v0.17.7 CLI unsafe fix help tasks
...
- 2026-05-01: CLI の安全性に関わる opt-in 導線のため、`v0.17.7` の release blocker として扱う。
...
- [x] 2.1 Cargo / npm / PyPI / MCP metadata を `0.17.7` に更新する
- [x] 2.2 README / docs / CHANGELOG を `0.17.7` に更新する
...
- [x] 3.9 `make release-check VERSION=v0.17.7`
- [x] 3.10 `make release-task-ledger-check VERSION=v0.17.7`
...
| release metadata | 15 | 15 | Cargo / wrappers / MCP / README / docs / CHANGELOG を `0.17.7` へ更新した。 |
| verification | 15 | 15 | 狭い CLI 契約、fmt-check、ast-lint、dogfood、lint、workspace test、diff check、release-check が成功。 |
| ledger | 5 | 5 | `make release-task-ledger-check VERSION=v0.17.7` の対象形式へ更新済み。 |
